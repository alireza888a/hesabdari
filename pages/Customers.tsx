            ...
            <form onSubmit={handleFormSubmit}>
              <div className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <input type="email" name="email" id="email" value={formData.email} onChange={handleFormChange} className="w-full p-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" dir="ltr" />
                </div>
                <div>
